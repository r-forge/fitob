...
/*
 * FitobLteExpression.hpp
 *
 *  Created on: Feb 27, 2010
 *      Author: benk
 */

#ifndef FITOBLTEEXPRESSION_HPP_
#define FITOBLTEEXPRESSION_HPP_
...
namespace fitob{
  ...
  /** */
  class LteExpression: public fitob::ExpressionBasis {
  public:

	 /** */
	  LteExpression(ExpressionBasis* left , ExpressionBasis* right);
    ...
    inline string toString() const { return "LteExpression(" +
