...
/*
 * FitobLtExpression.hpp
 *
 *  Created on: Feb 27, 2010
 *      Author: benk
 */

#ifndef FITOBLTEXPRESSION_HPP_
#define FITOBLTEXPRESSION_HPP_
...
namespace fitob{
  ...
  /** */
  class LtExpression: public fitob::ExpressionBasis {
  public:

	 /** */
	  LtExpression(ExpressionBasis* left , ExpressionBasis* right);
    ...
    inline string toString() const { return "LtExpression(" +
