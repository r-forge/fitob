...
/*
 * FitobGtExpression.hpp
 *
 *  Created on: Feb 27, 2010
 *      Author: benk
 */

#ifndef FITOBGTEXPRESSION_HPP_
#define FITOBGTEXPRESSION_HPP_
...
namespace fitob{
  ...
  /** */
  class GtExpression: public fitob::ExpressionBasis {
  public:

	 /** */
	  GtExpression(ExpressionBasis* left , ExpressionBasis* right);
    ...
    inline string toString() const { return "GtExpression(" +
