...
/*
 * FitobAndExpression.hpp
 *
 *  Created on: Feb 27, 2010
 *      Author: benk
 */

#ifndef FITOBANDEXPRESSION_HPP_
#define FITOBANDEXPRESSION_HPP_
...
namespace fitob{
  ...
  /** */
  class AndExpression: public fitob::ExpressionBasis {
  public:

	 /** */
	  AndExpression(ExpressionBasis* left , ExpressionBasis* right);
    ...
    inline string toString() const { return "AndExpression(" +
