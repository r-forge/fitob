...
/*
 * FitobDivExpression.hpp
 *
 *  Created on: Feb 27, 2010
 *      Author: benk
 */

#ifndef FITOBDIVEXPRESSION_HPP_
#define FITOBDIVEXPRESSION_HPP_
...
namespace fitob{
  ...
  /** */
  class DivExpression: public fitob::ExpressionBasis {
  public:

	 /** */
	  DivExpression(ExpressionBasis* left , ExpressionBasis* right);
