...
/*
 * FitobMultExpression.hpp
 *
 *  Created on: Feb 27, 2010
 *      Author: benk
 */

#ifndef FITOBMULTEXPRESSION_HPP_
#define FITOBMULTEXPRESSION_HPP_
...
namespace fitob{
  ...
  /** */
  class MultExpression: public fitob::ExpressionBasis {
  public:

	 /** */
	  MultExpression(ExpressionBasis* left , ExpressionBasis* right);
    ...
    inline string toString() const { return "MultExpression(" +
...
#endif /* FITOBMULTEXPRESSION_HPP_ */
